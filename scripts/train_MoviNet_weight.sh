...
target='Weight'
save_dir='/opt2/data/datasets/UCA-GAIT/train_results/weight_regression/'
#partitions_path='/opt2/data/datasets/UCA-GAIT/code/partitions/weight_regression'
partitions_path='/opt/data/jzafra/thesis/technical_validation/train_MoviNet_weight'
...
#     for partition in {0..3}; do
#         run_training 'optical_flow' $optical_flow_method $partition 0 'both' 'a5' &
#         pid1=$!
#         wait $pid1
#     done
# done

for optical_flow_method in 'TVL1'; do
